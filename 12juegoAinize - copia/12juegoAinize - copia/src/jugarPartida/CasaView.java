...
public class CasaView extends JFrame {
	...
	public CasaView() {
		...
		lblCajon.setIcon(new ImageIcon("D:\\Ainize\\02Programacion\\12juegoAinize\\img\\EXCLAMACION.png"));
		...
		lblMovil.setIcon(new ImageIcon("D:\\Ainize\\02Programacion\\12juegoAinize\\img\\MvlDesbloqueo.png"));
		getContentPane().add(lblMovil);
		lblMovil.setVisible(false);

		lblMvlChat = new JLabel("");
		lblMvlChat.setIcon(new ImageIcon("D:\\Ainize\\02Programacion\\12juegoAinize\\img\\tlfnChat1.png"));
		...
		btnMochila.setIcon(new ImageIcon("D:\\Ainize\\02Programacion\\12juegoAinize\\img\\mochila.png"));
		...
		lblFondoCasa.setIcon(new ImageIcon("D:\\Ainize\\02Programacion\\12juegoAinize\\img\\habitacionR.png"));
		getContentPane().add(lblFondoCasa);

		// Agregar un oyente para ajustar la imagen cuando cambie el tamaño de la
		// ventana
