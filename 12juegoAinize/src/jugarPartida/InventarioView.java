...
public class InventarioView extends JFrame {
	...
	public InventarioView() throws SQLException {
		...
		scrollPane.setBounds(1091, 0, 83, 421);
		...
		lblFondoAula.setIcon(new ImageIcon("D:\\Ainize\\02Programacion\\12juegoAinize\\img\\clase (2).png"));
		lblFondoAula.setBounds(10, 11, 1077, 559);
