...
public class Main extends JPanel {
	private String message = "El objetivo inmediato de los comunistas es el mismo que el de todos los demás partidos proletarios: constitución del proletariado como clase, derrocamiento del dominio de la burguesía, conquista del poder político por parte del proletariado.";
	...
	public static void main(String[] args) {
		JFrame frame = new JFrame("Texto tipo Pokémon");
		Main panel = new Main();
