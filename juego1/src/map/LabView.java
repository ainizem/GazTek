	...
	public LabView() {
		...
		addComponentListener(new ComponentAdapter() {
			...
			public void componentResized(ComponentEvent e) {
				...
				lblFondoLab.setBounds(0, 0, getWidth(), getHeight()); // Ajustar el tamaño del fondo para cubrir toda la
																		// ventana

				// Ajustar la posición del botón y otros elementos si es necesario
				btnPasillo2.setBounds(436, getHeight() - 80, 89, 23); // Ajustar la posición del botón según la altura
																		// de la ventana
				lblPasillo2.setBounds(434, getHeight() - 80, 91, 35); // Ajustar la posición de la flecha según la
																		// altura
