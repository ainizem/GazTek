    ...
    public BiblioView() {
        ...
        addComponentListener(new ComponentAdapter() {
            ...
            public void componentResized(ComponentEvent e) {
                ...
                btnPasillo2.setBounds(568, getHeight() - 80, 129, 35); // Ajustar la posición del botón según la altura de la ventana
                lblPasillo2.setBounds(543, getHeight() - 80, 94, 35); // Ajustar la posición de la flecha según la altura
