...
public class PatioView extends JFrame {
	public PatioView() {
		...
		lblPatio2.setIcon(new ImageIcon("img\\flecha-der.png"));
		...
		lblPasillo.setIcon(new ImageIcon("img\\flechote (1) (2).png"));
		...
		lblRecepcion.setIcon(new ImageIcon("img\\flechote (1) (2).png"));
		...
		lblFondoPatio.setIcon(new ImageIcon("img\\patio1R.png"));
