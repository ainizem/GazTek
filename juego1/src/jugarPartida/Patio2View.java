...
public class Patio2View extends JFrame{
	public Patio2View() {
		...
		lblRecepcion.setIcon(new ImageIcon("img\\flecha-abajo.png"));
		...
		lblPatio1.setIcon(new ImageIcon("img\\flecha-izq.png"));
		...
		lblCasa.setIcon(new ImageIcon("img\\flecha-der.png"));
		lblCasa.setBounds(617, 232, 57, 56);
		getContentPane().add(lblCasa);
		
		
		JLabel lblFondoPatio2 = new JLabel("");
		lblFondoPatio2.setIcon(new ImageIcon("img\\patio2R.png"));
